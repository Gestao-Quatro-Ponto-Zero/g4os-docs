...
<Warning>
  **Beta:** Input por voz e gravação de reunião são funcionalidades beta e ainda não foram disponibilizadas para todos os usuários. Se o ícone de microfone não aparecer na sua conta, entre em contato com o suporte.
</Warning>
