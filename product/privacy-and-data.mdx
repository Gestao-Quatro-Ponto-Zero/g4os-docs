...
| Transcrições e resumos de reunião | artefatos textuais locais da sessão |
| Áudio bruto de gravações | armazenamento local da sessão; não é conteúdo padrão de Cloud Sync |
